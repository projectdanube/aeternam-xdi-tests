 ...
 * @author markus
 */
public class VariablesGetInterceptor extends AbstractInterceptor<MessagingContainer> implements MessageEnvelopeInterceptor, OperationInterceptor, TargetInterceptor, Prototype<VariablesGetInterceptor> {

	private static final Logger log = LoggerFactory.getLogger(VariablesGetInterceptor.class);
	...
	@Override
	public VariablesGetInterceptor instanceFor(PrototypingContext prototypingContext) {
	...
	private static final String EXECUTIONCONTEXT_KEY_VARIABLES_PER_MESSAGEENVELOPE = VariablesGetInterceptor.class.getCanonicalName() + "#variablespermessageenvelope";
	private static final String EXECUTIONCONTEXT_KEY_VARIABLES_PER_OPERATION = VariablesGetInterceptor.class.getCanonicalName() + "#variablesperoperation";
